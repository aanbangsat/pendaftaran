      ...
      <div class="modal-body">
        ...
        <table class="table table-striped" width="100%">
            ...
            <td><select id="no_pelanggan_terdekat" name="no_pelanggan_terdekat"   class="form-control">
              ...
              <?php
              include '../koneksi.php';
                $exec=mysqli_query($conn,"select * from pelanggan");
...
<table class="table table-striped">
    ...
    <?php
        include '../koneksi.php';
        if(!isset($_GET['data']))
        $exec=mysqli_query($conn,"select * from pendaftar ");
        else{
            $data=trim(addslashes($_GET['data']));
            $exec=mysqli_query($conn,"select * from pendaftar where kdpendaftar like '%".$data."%' or nama like '%".$data."%'");
        }
