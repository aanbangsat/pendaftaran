...
include "../koneksi.php";
                if(isset($_POST['nama'])){
                                ...
                                mysqli_query($conn,"insert into pendaftar values('','$nama','$jenkel','$kdagama','$tpt_lahir','$tgl_lahir','$alamat',
    ...
    <div class="row">
					...
					<div class="col-md-12">
						<div class="grey-box-icon b4">  
							 <h4 class="modal-title" id="myModalLabel">Isi Data pendaftar</h4>
        ...
        <table class="table " width="100%">
          <tr>
            ...
            <td><select  name="kdtk"   class="form-control" required  >
              ...
              <?php
                $exec=mysqli_query($conn,"select * from tk");
                while($hasil=mysqli_fetch_array($exec))
                  echo "<option value='$hasil[0]'> $hasil[1]</option>";
              ?>
            </select></td>
            ...
            <tr>
                ...
                <td width="1%"> : </td>
                <td> <input id="tgl_lahir" name="tgl_lahir" placeholder="Tanggal LAhir" class="form-control"  type="text" required></td>
            </tr>
            <tr>
            ...
            <td><select  name="kdpendidikana"   class="form-control" required>
              ...
              <?php
                $exec=mysqli_query($conn,"select * from pendidikan");
                while($hasil=mysqli_fetch_array($exec))
                  echo "<option value='$hasil[0]'> $hasil[1]</option>";
              ?>
            </select></td>
           ...
           <tr>
            ...
            <td><select  name="kdpekerjaana"   class="form-control" required>
              ...
              <?php
                $exec=mysqli_query($conn,"select * from pekerjaan");
                while($hasil=mysqli_fetch_array($exec))
                  echo "<option value='$hasil[0]'> $hasil[1]</option>";
              ?>
            </select></td>
 ...
 <tr>
  ...
  <div class="footerbottom">
    ...
    <div class="col-md-12 col-sm-7"> 
            ...
            <i class="fa fa-map-marker"></i> Kelompok 1<br>
            <i class="fa fa-phone"></i>+82132131 <br>
             <i class="fa fa-envelope-o"></i> sekolah@gmail.com
              </div> 
                </div><!-- end widget --> 
    </div>
  </div>
				...
				<div class="row">
					...
					<div class="col-md-12 panel">
						<div class="panel-body">
							<p class="text-right">
								Copyright &copy; 2019. Kelompok 1
							</p>
						</div>
					</div>
